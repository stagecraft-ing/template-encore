...
path template) is owned by spec 011; this spec references it.
...
by spec 011). This spec records that the example carries a documented generic
...
provisioning a registry and secrets, and SHA-pinning every `uses:` (spec 015).
