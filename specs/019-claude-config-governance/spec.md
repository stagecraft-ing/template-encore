...
# 019 — Claude Code shared config governance: .mcp.json and .claude/settings.json as hashed inputs
...
and `.claude/agents/` surfaces are owned by spec `018-claude-skills`. The
...
- **AC-4:** The committed `.derived/codebase-index/by-spec/019-claude-config-governance.json`
