...
export function Environment(name: string): BaseURL {
    return `https://${name}-bmgpc.encr.app`
}
...
/**
 * Client is an API client for the bmgpc Encore application.
 */
...
export namespace auth {
    ...
    drivers: string[]
        ...
        public async getCsrfToken(method: "GET", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
...
export namespace health {
    ...
    export class ServiceClient {
         ...
         */
        public async health(): Promise<StatusResponse> {
            // Now make the actual call to the API
         ...
         */
        public async liveness(): Promise<StatusResponse> {
            // Now make the actual call to the API
         ...
         */
        public async readiness(): Promise<StatusResponse> {
            // Now make the actual call to the API
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "bmgpc-Generated-TS-Client (Encore/v1.57.5)";
        }
